...
patch(ListRenderer.prototype, {
    setup(){
        ...
        this._adjustTreeViewWidth();
    },

    _adjustTreeViewWidth() {
    setTimeout(() => {
        ...
        if (listView) {
            ...
            listView.style.maxWidth = '100%';
            listView.style.marginRight = '0';
        }
        if (actionManager) {
            actionManager.style.width = '100%';
            actionManager.style.marginRight = '0';
        }

        // Find the parent div and force it to take the full width
    ...
    }, 500); // Allow some delay for DOM to load
},
